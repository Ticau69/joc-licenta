...
public class LuminiStalp : MonoBehaviour
{
    ...
    private void ApplyIntensity(float intensity)
    {
        ...
        if (bulbRenderer != null)
        {
            ...
            bulbRenderer.GetPropertyBlock(_propBlock, bulbMaterialIndex);
            _propBlock.SetColor(EmissionColor, emissive);
            bulbRenderer.SetPropertyBlock(_propBlock, bulbMaterialIndex);
        }
    }
